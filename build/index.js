...
class SimpleGreetingServer {
    server;
    constructor() {
        console.error('[Setup] Inicializando Simple Greeting MCP server...');
        this.server = new Server({
            name: 'simple-greeting-mcp-server',
            version: '0.1.0',
        }, {
            capabilities: {
                tools: {},
    ...
    setupToolHandler() {
        // Registrar la herramienta que saluda al usuario.
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            if (!args.name) {
                throw new McpError(ErrorCode.InvalidParams, 'Falta el parámetro requerido: name');
            }
